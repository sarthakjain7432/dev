...
upload.addEventListener("click", (e) => {
    let input = document.createElement("input"); //to add image from file manager
...
//for minimize and remove sticky note
function noteActions(minimize, remove, stickyCont) {
    ...
    minimize.addEventListener("click", (e) => {
        ...
        let display = getComputedStyle(noteCont).getPropertyValue("display"); //to find whether display of noteCont is block or none
